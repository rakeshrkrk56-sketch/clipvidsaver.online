...
export default function Founder() {
  return (
    <>
      ...
      <h1 className="text-4xl md:text-5xl font-black text-white mb-4 tracking-tight">About the Founder</h1>
      <p className="text-xl text-slate-400 mb-12">Built independently with a focus on simplicity and creator freedom.</p>

      <div className="bg-slate-900 p-8 rounded-3xl shadow-xl shadow-black/10 border border-slate-800 mb-12">
        <h2 className="text-2xl font-bold text-slate-100 mb-1">ClipVidSaver.online Founder</h2>
        <p className="text-indigo-400 font-medium mb-4">Independent Developer & Creator</p>
      ...
      <div className="space-y-12">
        ...
        <section>
          <h2 className="text-2xl font-bold text-white mb-4">What This Site Is</h2>
          <div className="prose prose-lg text-slate-400">
        ...
        <section>
          <h2 className="text-2xl font-bold text-white mb-4">My Commitment to Users</h2>
        ...
        <section>
          ...
          <a href="mailto:claire9360@gmail.com" className="text-indigo-400 font-semibold hover:text-indigo-300 transition-colors text-lg">claire9360@gmail.com</a>
        </section>
      </div>
    </div>
    </>
