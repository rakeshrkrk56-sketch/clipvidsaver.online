...
export default function Copyright() {
  return (
    <>
      ...
      <h1 className="text-4xl md:text-5xl font-black text-slate-900 mb-4 tracking-tight">Copyright Policy & DMCA</h1>
      ...
      <div className="prose prose-lg text-slate-600 max-w-none space-y-8">
        ...
        <section>
          <h2 className="text-2xl font-bold text-slate-900 mt-8 mb-4">Copyright Respect</h2>
        ...
        <section>
          <h2 className="text-2xl font-bold text-slate-900 mt-8 mb-4">User Responsibility</h2>
        ...
        <section>
          <h2 className="text-2xl font-bold text-slate-900 mt-8 mb-4">No Storage or Hosting</h2>
        ...
        <section>
          <h2 className="text-2xl font-bold text-slate-900 mt-8 mb-4">No Content Indexing</h2>
        ...
        <section>
          <h2 className="text-2xl font-bold text-slate-900 mt-8 mb-4">DMCA Takedown Procedure</h2>
        ...
        <section>
          <h2 className="text-2xl font-bold text-slate-900 mt-8 mb-4">DMCA Contact</h2>
          <p>Send copyright or DMCA-related notices to:</p>
          <p className="mt-2"><a href="mailto:claire9360@gmail.com" className="text-indigo-600 font-semibold hover:text-indigo-500 transition-colors">claire9360@gmail.com</a></p>
        </section>

        <section>
          <h2 className="text-2xl font-bold text-slate-900 mt-8 mb-4">Response Policy</h2>
