...
export default function About() {
  return (
    <>
      ...
      <h1 className="text-4xl md:text-5xl font-black text-white mb-4 tracking-tight">About ClipVidSaver</h1>
      <p className="text-xl text-slate-400 mb-12">The dedicated platform for downloading Meta AI videos without watermarks.</p>
      ...
      <div className="space-y-12">
        ...
        <section>
          <h2 className="text-2xl font-bold text-white mb-4">Why ClipVidSaver</h2>
