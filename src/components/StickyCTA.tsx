...
export default function StickyCTA() {
  ...
  return (
    <div className="fixed bottom-0 left-0 w-full z-50 md:hidden bg-slate-900 border-t border-slate-800 p-3 shadow-lg flex justify-center pb-[max(env(safe-area-inset-bottom),12px)]">
      <button
        onClick={scrollToTop}
